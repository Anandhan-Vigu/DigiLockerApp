    ...
    return (
        <div className="space-y-5 min-h-screen text-black p-5 bg-white mb-7">
            ...
            <div className="flex items-center  gap-2 border-b border-gray-200 pb-2 ">
                <img src="/umang/umang.png"  alt="UMANG" className="w-8 h-10" />
            ...
            {/* Bottom Section */}
            <div className="fixed bottom-0 left-0 w-full py-3 flex gap-2 items-center justify-center bg-white border-gray-200 border-t">
                ...
                <div className="flex items-center gap-1 bg-[#eaf6ff] px-2 py-1 rounded-full">
                    <img src="/umang/umang.png" alt="UMANG" className="w-7 h-10" />
